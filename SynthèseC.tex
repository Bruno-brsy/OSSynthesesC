...
Cette fonction permet de réveiller tous les thread qui surveille la condition cond. Tout comme pthread\textunderscore{}cond\textunderscore{}signal, elle prend en paramètre l'adresse de la variable-condition surveillée. 
\begin{lstlisting}
